#
#  Be sure to run `pod spec lint CDBleSDK.podspec' to ensure this is a
...
s.license      = { :type => "MIT", :file => "LICENSE" }   # s.license      = { :type => "MIT", :file => "FILE_LICENSE" }
  ...
  s.author             = { "LELE" => "lelezpGZ@163.com" }
  # Or just: s.author    = "LELE"
  # s.authors            = { "LELE" => "le.yu@chargedot.com" }
  # s.social_media_url   = "http://twitter.com/LELE"
